...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/muhammad-rizki-saputra-70b676330/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@rizzproject",
    icon: Instagram,
    url: "https://www.instagram.com/kaiiriz._/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@RIZZ",
    icon: Youtube,
    url: "https://www.youtube.com/@RizzProject",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@rizzproject",
    icon: Github,
    url: "https://github.com/rizzproject",
    color: "#ffffff",
